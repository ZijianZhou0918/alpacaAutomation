...
ROOT_PYTHON_ENTRIES = {
    ...
    "run_backtest_data_repair.py",
    "run_backtest_data_spotcheck.py",
    "run_backtest_data_sync.py",
    "run_backtest_gap_strategy_current_daily3_optimization.py",
    "run_backtest_gap_strategy_optimization.py",
    "run_backtest_gap_strategy_return_validation.py",
    "run_backtest_gap_strategy_validation.py",
    "run_backtest_signal_dynamic_ma5.py",
