...
STRATEGY_DESCRIPTION = (
    "Win-rate-optimized gap-confirmed pullback strategy "
    "(legacy identifier retained; the separate total-return candidate remains "
    "research-only after failing its absolute Q4 holdout): "
    "fixed single buy $2,500; "
    "max_daily_buys=3; max_positions=3; signal gain >8%; signal gain beats MA5 by >2%; "
    ...
    "to -8%..-5% from the signal close and remains at/above the dynamic MA5; "
    "stop loss 8%; take profit at 4% selling all; no overnight holding. "
    "The three-buy cap is user-mandated; the original signal rules were retained "
    "after the only frozen 2025 optimization candidate failed 2025-Q4 and 2026 "
    "cross-validation."
)
...
BUY_SIGNAL_PARAMS = {
    ...
    "MAX_BUY_TODAY_CURRENT_GAIN_PCT": -0.05,
...
STOP_PARAMS = {
    ...
    "take_profit_half_pct": 0.04,
    "take_profit_sell_fraction": 1.00,
    "take_profit_remainder_stop_pct": 0.04,
}
